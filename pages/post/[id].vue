<template>
    ...
    >
        ...
        >
            ...
            <div class="px-8 mt-4 text-sm">Some text for the post</div>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] font-light">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem repudiandae voluptates nobis expedita explicabo. Exercitationem molestias consectetur est, animi iste ipsa iure praesentium dolorum perferendis! Est vitae deleniti odio possimus.
                            </div>
                        </div>
                    </div>
                </div>
